...
# Flips/Triggers
flips=[]
if price>levels["breakout_weak"]: flips.append(f"Bullish breakout (weak ≥ ${fmt(levels['breakout_weak'])})")
if price>levels["breakout_strong"]: flips.append(f"Bullish breakout (strong ≥ ${fmt(levels['breakout_strong'])})")
if price<levels["breakdown_weak"]: flips.append(f"Bearish breakdown (weak ≤ ${fmt(levels['breakdown_weak'])})")
if price<levels["breakdown_strong"]: flips.append(f"Bearish breakdown (strong ≤ ${fmt(levels['breakdown_strong'])})")
if price<levels["danger"]: flips.append(f"DANGER: below danger level ≤ ${fmt(levels['danger'])}")
